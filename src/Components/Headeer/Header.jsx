    ...
    display: "flex", justifyContent: "center" 
              ...
              <Grid item xs={4} sx={{ display: "flex", justifyContent: "flex-end", alignItems: "center" }}>
                ...
                <Modal open={open} onClose={handleClose}>
                  <Box sx={{ display: "flex", position: 'absolute', top: '15%', left: '90%', transform: 'translate(-50%, -50%)', width: 150, height: 80, bgcolor: 'background.paper', boxShadow: 24, borderRadius: 2, p: 3, textAlign: 'center', cursor: "pointer" }}>
...
<DeleteIcon style={{cursor:"pointer"}}  onClick={() => dispatch(Delete(item))}/>
      ...
      <Modal open={isLoginModalOpen} onClose={handleLoginModalClose}>
        <Box sx={{ position: 'absolute', top: '30%', left: '50%', transform: 'translateX(-50%)', bgcolor: 'background.paper', boxShadow: 24, borderRadius: 2, p: 3 }}>
      ...
      <TemporaryDrawer handleDrawerTogglee={handleDrawerTogglee} isDrawerOpen= {isDrawerOpen} />
